  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center p-4 bg-bg-base">
      ...
      >
        ...
        <h1 style={{ color: 'var(--primary-500)' }} className="text-3xl font-bold">KidsChores</h1>
      ...
      >
        ...
        >
          ...
          <button
            type="button"
            disabled
            className="w-full py-3 px-4 rounded-xl border border-bg-accent bg-bg-base text-text-secondary font-medium flex items-center justify-center gap-2 hover:bg-bg-accent focus:outline-none focus:ring-2 focus:ring-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
