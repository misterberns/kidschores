...
[![Version](https://img.shields.io/badge/Version-v0.7.7-green?style=flat-square)](https://github.com/misterberns/kidschores/releases)
...
Current version: **0.7.7** (see [CHANGELOG.md](CHANGELOG.md) for history)
